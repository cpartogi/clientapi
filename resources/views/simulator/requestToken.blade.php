...
<html>
    <head>
        ...
        <title>H2H Partner - Request Token</title>
        ...
        <script type="text/javascript">
         ...
         function getWords() {
			var msg = document.H2HPartner.clientId.value + document.H2HPartner.systraceSignOn.value + document.H2HPartner.SHAREDKEY.value + document.H2HPartner.accountId.value;          
    ...
    <body onload="getTimestamp();
        ...
        <div>
            <form name="H2HPartner" method=post action="http://dev.dokupay.com/dokupay/h2h/requesttoken">
                
                <div>
                    <table width="100%">
                        <tr>
                            <td align="center" colspan="2">REQUEST TOKEN<td>
                        </tr>
                      
                        <tr>
                            <td align="right">accessToken*</td>
                            <td><input type="text" name="accessToken" value=""/>
                            <br>accessToken when sign on
                            </td>
                            <br>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="right">systraceSignOn*</td>
                            <td><input type="text" name="systraceSignOn" value=""/>
                            <br>systrace when sign on
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="hidden" name="SHAREDKEY" value="*5df7h568gf"/></td>
                            <td><input type="hidden" name="secretkey" value="aas76g8dj"/></td>
                        </tr>
                        <tr>
                            <td align="right">ELEMENTWORDS</td>
                            <td><input type="text" name="ELEMENTWORDS" size="60" readonly="readonly"/>
                            <br>encrypted SHA1 HMAC, from element :(clientId + systraceSignOn + sharedKey + accountId)
                        </tr>
                        <tr>
